...
--
-- Host: 127.0.0.1:3306
-- Creato il: Feb 19, 2026 alle 08:52
...
CREATE TABLE `utenti` (
  ...
  `token` char(248) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(5, 'Marcello.Pigini@iismarconipieralisi.it', 'Pigini', 'Pigini', 'Marcello', 'C', 'L', '000000064', '101993895114608448939'),
