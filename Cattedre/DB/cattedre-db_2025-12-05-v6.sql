...
--
-- Host: 127.0.0.1:3306
-- Creato il: Dic 05, 2025 alle 12:03
...
INSERT INTO `assegnare` (`ID`, `dal`, `al`, `IDannoscolastico`, `IDutente`, `IDdisciplina`, `IDclasse`) VALUES
(1, '2024-09-11', '2025-06-07', 1, 1, 1, 1),
(3, '2024-09-11', '2025-06-07', 1, 5, 2, 1),
(4, '2024-09-11', '2025-06-07', 1, 2, 19, 4),
(5, '2024-09-11', '2025-06-07', 1, 1, 23, 7);
...
INSERT INTO `richiedere` (`IDutente`, `IDclasseDiConcorso`, `IDdisciplina`) VALUES
(1, 2, 1),
(2, 1, 2),
(5, 1, 2);
...
CREATE TABLE `utenti` (
  ...
  `nome` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `tipoUtente` char(2) CHARACTER SET armscii8 COLLATE armscii8_general_ci NOT NULL COMMENT 'P=Preside, A=Amministratore, D=Docente, CD=Coordinatore del dipartimento ',
...
INSERT INTO `utenti` (`ID`, `email`, `password`, `cognome`, `nome`, `tipoUtente`, `tipoDocente`) VALUES
...
(5, 'marcello.pigini@iismarconipieralisi.it', 'marpig00!', 'Pigini', 'Marcello', 'CD', 'T'),
...
(8, 'alessandro.savore@iismarconipieralisi.it', 'alesav00!', 'Savore', 'Alessandro', 'CD', 'T'),
(9, 'vittorio.alfieri@iismarconipieralisi.it', 'vitalf00!', 'Alfieri', 'Vittorio', 'A', NULL);
